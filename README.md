...
**Note on iMuJoCo**: The `imujoco` benchmark requires manual installation as it is not a standard Python package.
1. Clone the repository: `git clone https://github.com/mpatacchiola/imujoco.git`
2. Add it to your PYTHONPATH: `export PYTHONPATH=$PYTHONPATH:/path/to/imujoco`
